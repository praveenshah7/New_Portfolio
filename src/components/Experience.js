...
export default function Experience() {
  ...
  return (
    <section id="experience" style={{ padding: '7rem 5rem', background: '#0d0d12' }}>
      <div style={{ fontFamily: "'Space Mono', monospace", fontSize: '.65rem', letterSpacing: '3px', color: '#00ff88', textTransform: 'uppercase', marginBottom: '.5rem' }}>// 03</div>
        ...
        {experiences.map((exp, i) => (
          <div key={i}
            style={{
              ...
              padding: '2.5rem 1rem', borderBottom: '1px solid rgba(255,255,255,0.07)',
      ...
      <style>{`@media(max-width:768px){ #experience .exp-grid { grid-template-columns: 1fr !important; } }`}</style>
    </section>
  );
}
